...
直接用浏览器打开根目录的 `index.html` 可查看沿途电台版，打开 `minimal/index.html` 可查看极简专注版。两个页面均保持为独立的单文件网页。
...
`minimal/` 子目录会由同一个 GitHub Pages 站点发布为独立 URL，不会覆盖仓库根目录首页。

## 说明

两个版本都是独立静态页面，无需服务端。发布到 GitHub Pages 后，页面和公开仓库内容可被其他人访问。
